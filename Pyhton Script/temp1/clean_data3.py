...
# Define MySQL query
query = "SELECT employee_id,attendance_date, punch_in, punch_out FROM dim_attendance_time"
...
for i in allEmployeeIds:
    for j in allDates:
        timelist = []
        querydy = "SELECT employee_id,attendance_date, punch_in, punch_out FROM dim_attendance_time WHERE employee_id = {} and attendance_date = '{}'".format(i, j)
